...
public class InformationController {
    ...
    @GetMapping("/update")
    public String create(InformationForm informationForm){
        return "information_form";
    }

    @PostMapping("/update")
    public String create(@Valid InformationForm informationForm, BindingResult bindingResult,  @RequestParam("image") MultipartFile image){
        ...
        if (image != null && !image.isEmpty()) {
            ...
            informationService.create(informationForm.getImagePath(), informationForm.getHealthName(), informationForm.getCompanyNumber(),
